        ...
        <div class="right_yh bj_fff" style="width:408px;height: 438px;">
            <form action="${ctx}/login/utoLogin" method="post">
                ...
                <div class="center_yh hidden_yh" style="width: 336px;">
                    ...
                    <input type="submit" value="登录" class="center_yh" style="width: 100%;height: 43px;font-size: 16px;background: #dd4545;outline: none;border: 0;color: #ffffff; cursor:pointer;">
                    <div style="margin-top: 20px;background-color:#dd4545;text-align:center;">
                        <a style="line-height: 43px;" href="${ctx}/login/res">注册</a>
                    </div>
                </div>
            </form>
        </div>
