...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        <font class="left_yh">欢迎来到校园超市！</font>
        <div class="right_yh" id="fast_jump">
            <a href="${ctx}/login/mtuichu">管理员登录</a>
            <a href="${ctx}/login/dtuichu">送货员登录</a>
...
<div class="width100 hidden_yh">
    <div class="width1200 center_yh hidden_yh">
        <a href="#" class="block_yh left_yh">
            <img src="${ctx}/resource/images/zuel.png" alt="" style="height: 70px;margin-top: 15px;margin-left: 20px;">
        </a>
